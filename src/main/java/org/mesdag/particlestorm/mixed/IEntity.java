...
public interface IEntity extends ParticleEmitterAttachable {
    ...
    @Override
    default Vec3 getPos() { return ((Entity) this).position(); }

    @Override
    default Level getLevel() { return ((Entity) this).level(); }

    @Override
    default boolean isDiscarded() { return ((Entity) this).isRemoved(); }

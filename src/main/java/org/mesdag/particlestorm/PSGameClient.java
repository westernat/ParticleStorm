...
public final class PSGameClient implements ClientModInitializer {
    ...
    public static final ParticleRenderType PARTICLE_ADD = new ParticleRenderType() {
        ...
        public void begin(BufferBuilder buffer, TextureManager textureManager) {
            if (!IRIS_LOADED) {
                RenderSystem.setShader(() -> particleAdd);
            }
    ...
    private static ShaderInstance particleAdd;
    ...
    public void onInitializeClient() {
        CoreShaderRegistrationCallback.EVENT.register(context -> {
            ...
            context.register(ParticleStorm.asResource("particle_add"), DefaultVertexFormat.PARTICLE, shader -> particleAdd = shader);
        });

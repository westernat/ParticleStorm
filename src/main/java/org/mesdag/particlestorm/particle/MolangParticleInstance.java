...
public class MolangParticleInstance extends TextureSheetParticle implements IMolangParticleInstance {
    ...
    public void render(VertexConsumer buffer, Camera camera, float partialTicks) {
        ...
        renderRotatedQuad(buffer, camera, partialTicks);
    }

    protected void renderRotatedQuad(VertexConsumer buffer, Camera camera, float partialTicks) {
        ...
        renderRotatedQuad(buffer, f, f1, f2, partialTicks);
    }
    ...
    protected void renderRotatedQuad(VertexConsumer buffer, float x, float y, float z, float partialTicks) {
        ...
        renderVertex(buffer, x, y, z, -1.0F, -1.0F, f1, f4, i);
        renderVertex(buffer, x, y, z, -1.0F, 1.0F, f1, f3, i);
        renderVertex(buffer, x, y, z, 1.0F, 1.0F, f2, f3, i);
        renderVertex(buffer, x, y, z, 1.0F, -1.0F, f2, f4, i);
    }
    ...
    protected void renderVertex(
        ...
        vector.set(xOffset * billboardSize[0], yOffset * billboardSize[1], 0.0F).rotate(quaternionf).add(x, y, z);
        buffer.vertex(vector.x(), vector.y(), vector.z()).uv(u, v).color(rCol, gCol, bCol, alpha).uv2(packedLight).endVertex();
    }

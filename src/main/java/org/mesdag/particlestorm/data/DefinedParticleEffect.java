...
public class DefinedParticleEffect {
    public static final Codec<DefinedParticleEffect> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            Codec.dispatchedMap(Identifier.CODEC, IComponent.COMPONENTS::get).fieldOf("components").forGetter(effect -> effect.components),
    ...
    public final Map<Identifier, IComponent> components;
    ...
    public DefinedParticleEffect(ParticleDescription description, Map<String, ParticleCurve> curves, Map<Identifier, IComponent> components, Map<String, Map<String, IEventNode>> events) {

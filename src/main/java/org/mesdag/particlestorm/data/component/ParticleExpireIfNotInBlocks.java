...
public final class ParticleExpireIfNotInBlocks implements IParticleComponent {
    ...
    @Override
    public Deserializer<ParticleExpireIfNotInBlocks> deserializer() {
        return ParticleExpireIfNotInBlocks::fromJson;
    }
    ...
    public static ParticleExpireIfNotInBlocks fromJson(JsonElement element) {
        ImmutableSet.Builder<String> builder = ImmutableSet.builder();
        for (JsonElement jsonElement : element.getAsJsonArray()) {
            builder.add(jsonElement.getAsString());
        }
        return new ParticleExpireIfNotInBlocks(builder.build());
    }
}

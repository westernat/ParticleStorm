...
public final class ParticleCurve {
    ...
    public static ParticleCurve fromJson(JsonElement element) {
        JsonObject object = element.getAsJsonObject();
        CurveType type = CurveType.fromJson(object.get("type"));
        FloatMolangExp input = FloatMolangExp.fromJson(GsonHelper.getNonNull(object, "input"));
        FloatMolangExp horizontalRange = FloatMolangExp.fromJson(object.get("horizontal_range"), FloatMolangExp.ONE);
        CurveNodes nodes = CurveNodes.fromJson(GsonHelper.getNonNull(object, "nodes"), type);
        return new ParticleCurve(type, input, horizontalRange, nodes);
    }
}

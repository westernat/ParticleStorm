...
public record Operator(String symbol, int precedence, Operation operation) implements Comparable<Operator> {
    ...
    public static final Operator ADD = register("+", 1, Float::sum);
    ...
    public static final Operator POW = register("^", 3, (a, b) -> (float) Math.pow(a, b));
    ...
    public static final Operator EQUAL = register("==", 5, (a, b) -> Math.abs(a - b) < Mth.EPSILON ? 1 : 0);
    public static final Operator NOT_EQUAL = register("!=", 5, (a, b) -> Math.abs(a - b) >= Mth.EPSILON ? 1 : 0);
    ...
    public float compute(float argA, float argB) {
    ...
    public interface Operation {
        ...
        /// @param argB The second input argument
        /// @return The computed value of the two inputs
        float compute(float argA, float argB);
    }
}

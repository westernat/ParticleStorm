...
public final class MolangQueries {
    ...
    private static void setDefaultQueryValues() {
        ...
        registerQueryVariable("query.has_cape", p -> Minecraft.getInstance().player == null ? 0.0 : Minecraft.getInstance().player.getCloakTextureLocation() == null ? 0 : 1);
        ...
        registerQueryVariable("query.moon_brightness", p -> {
            ...
            return DimensionType.MOON_BRIGHTNESS_PER_PHASE[(int) phase];
        });
        registerQueryVariable("query.moon_phase", p -> p.getLevel().getGameTime() / 24000L % 8L);
